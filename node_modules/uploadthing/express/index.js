...
import { ValidContentDispositions, ValidACLs, fetchEff, generateUploadThingURL, parseResponseJson, RetryError, exponentialBackoff, UploadThingError, signPayload, isObject, bytesToFileSize, getTypeFromFileName, objectKeys, InvalidRouteConfigError, fileSizeToBytes, FetchContext, getFullApiUrl, verifySignature, parseRequestJson, fillInputRouteConfig, filterObjectValues, getStatusCodeFromError } from '@uploadthing/shared';
...
const toWebRequest = (req, body)=>{
    ...
    return parseURL(req).pipe(Effect.catchTag("InvalidURL", (e)=>Effect.die(e)), Effect.andThen((url)=>new Request(url, {
            method,
            headers: filterObjectValues(req.headers ?? {}, (v)=>typeof v === "string"),
            ...allowsBody ? {
                body: bodyStr
            } : {}
        })));
