...
declare const InvalidJsonError_base: new <A extends Record<string, any> = {}>(args: effect_Types.Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }) => effect_Cause.YieldableError & {
    readonly _tag: "InvalidJsonError";
} & Readonly<A>;
declare class InvalidJsonError extends InvalidJsonError_base<{
...
declare class BadRequestError<T = unknown> extends BadRequestError_base<{
